...
namespace nora
{
#define TEST_CUBE_TEXTURE_WIDTH 2
#define TEST_CUBE_TEXTURE_HEIGHT 2

    unsigned int testCubeTextureData[] = // 2x2 pixel checkerboard pattern, 0xAARRGGBB
        {
            0xffffffff,
            0xff7f7f7f,
            0xff7f7f7f,
    ...
    unsigned int testCubeIndexData[] = {
